...
class WalkingMixin:  # Mixin suffix is a convention signalling that it's a mix-in and shouldn't be instantiated like a
    # regular class
    def walk(self):
        print("Let's go for a walk!")


class Cat(WalkingMixin):  # inheriting from WalkingMixin gives Cat access to the walk method
